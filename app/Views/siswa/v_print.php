...
<body>
   <div class="judul">
      <center>
         ...
         <h3 style="margin: 0px;">DATA RIWAYAT TABUNGAN </h3>
         <hr>
         <p class="identitas"><?= $siswa['nama_siswa']; ?></p>
         <p class="identitas">NIS : <?= $siswa['nis']; ?></p>
      </center>
   </div>
      ...
      <table class="table table-bordered" style="width: 100%;  ">
         ...
         <tfoot>
            ...
            <tr>
               ...
               <td colspan="3" style="background-color: #16c745;">
                  <center><b><?= buatRupiah($total_saldo); ?></b></center>
               </td>
            </tr>
         </tfoot>
      </table>
...
<script>
   window.onload(
      window.location.href = "<?= base_url('siswa/cetak/download'); ?>"
   );
</script>
